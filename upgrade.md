...
Attention quand tu écrits le code. Par exemple dans ton code tu as :
...
Je te conseil [ce site](https://www.php.net/supported-versions) qui permet de suivre les versions de PHP.
...
On pourra même faire encore mieux avec l'injection de dépendanes.
